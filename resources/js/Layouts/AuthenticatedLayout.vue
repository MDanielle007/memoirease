			...
			>
				...
				<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
					<div class="flex h-16 justify-between">
						...
						<div
							class="hidden sm:ms-6 sm:flex sm:items-center justify-center pt-4"
						>
							<!-- Settings Dropdown -->
						...
						<!-- Hamburger -->
						<div class="-me-2 flex items-center sm:hidden justify-center">
				...
				<Popover ref="op">
					<div class="border-gray-200 pb-1 pt-4 dark:border-gray-600">
